...
class bot:
    ...
    def login(self):
        ...
        # direct button
        self.bot.find_element_by_xpath(
            '/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[2]/a/div/div/div').click()
        time.sleep(3)
        ...
        for i in user:
            ...
            self.bot.find_element_by_xpath(
                '/html/body/div[6]/div/div/div[2]/div[2]/div[1]/div/div[2]/div[1]/div/div').click()
            time.sleep(2)
